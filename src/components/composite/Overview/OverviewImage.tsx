...
const OverviewImage = ({ data }: OverviewProps) => {
  ...
  const isActiveItem = () => {
    return selectedIndex === mainCarouselMethods?.selectedScrollSnap()
  ...
  return (
    <div className="overview__image">
      <div className="overview__image--main" ref={mainCarouselRef}>
      ...
      <div className="overview__image--sub" ref={subCarouselRef}>
        <div className="overview__image__list">
          <CustomImage
            src={data.image.imageUrl}
            alt="Editor Desktop"
            className={`overview__image__item ${isActiveItem()}`}
            width={0}
            height={0}
            sizes="100vw"
            onClick={() => handleSubCarouselClick(0)}
          />
          <CustomImage
            // src={data.product_images[0]}
            src="data:image/jpeg;base64,"
            ...
            height={0}
            sizes="100vw"
            onClick={() => handleSubCarouselClick(1)}
          />
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            ...
            height={0}
            sizes="100vw"
            onClick={() => handleSubCarouselClick(2)}
          />
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            ...
            height={0}
            sizes="100vw"
            onClick={() => handleSubCarouselClick(3)}
          />
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            ...
            height={0}
            sizes="100vw"
            onClick={() => handleSubCarouselClick(4)}
          />
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            ...
            height={0}
            sizes="100vw"
            onClick={() => handleSubCarouselClick(5)}
          />
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            ...
            height={0}
            sizes="100vw"
            onClick={() => handleSubCarouselClick(6)}
          />
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            ...
            height={0}
            sizes="100vw"
            onClick={() => handleSubCarouselClick(7)}
          />
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            ...
            height={0}
            sizes="100vw"
            onClick={() => handleSubCarouselClick(8)}
          />
        </div>
      </div>
    </div>
