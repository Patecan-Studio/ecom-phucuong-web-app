    ...
    <div className="overview__image--sub" ref={ref}>
        <div className="overview__image__list">
          <CustomImage
            ...
            alt="Editor Desktop"
            className={`overview__image__item ${isActiveItem(0)}`}
            width={0}
            height={0}
            sizes="100vw"
            onClick={() => onClick(0)}
          ...
          <CustomImage
            ...
            alt="Editor Desktop"
            className={`overview__image__item ${isActiveItem(1)}`}
            width={0}
            height={0}
            sizes="100vw"
            onClick={() => onClick(1)}
          ...
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            className={`overview__image__item ${isActiveItem(2)}`}
            width={0}
            height={0}
            sizes="100vw"
            onClick={() => onClick(2)}
          ...
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            className={`overview__image__item ${isActiveItem(3)}`}
            width={0}
            height={0}
            sizes="100vw"
            onClick={() => onClick(3)}
          ...
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            className={`overview__image__item ${isActiveItem(4)}`}
            width={0}
            height={0}
            sizes="100vw"
            onClick={() => onClick(4)}
          ...
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            className={`overview__image__item ${isActiveItem(5)}`}
            width={0}
            height={0}
            sizes="100vw"
            onClick={() => onClick(5)}
          ...
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            className={`overview__image__item ${isActiveItem(6)}`}
            width={0}
            height={0}
            sizes="100vw"
            onClick={() => onClick(6)}
          ...
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            className={`overview__image__item ${isActiveItem(7)}`}
            width={0}
            height={0}
            sizes="100vw"
            onClick={() => onClick(7)}
          ...
          <CustomImage
            src={data.product_images[0]}
            alt="Editor Desktop"
            className={`overview__image__item ${isActiveItem(8)}`}
            width={0}
            height={0}
            sizes="100vw"
            onClick={() => onClick(8)}
